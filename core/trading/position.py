...
# Комиссия тейкера по умолчанию: 0.08%, как её берёт WEEX. Обе ноги позиции -
# вход и выход - платят её, поэтому в безубытке она считается дважды. Прежние
# 0.04% занижали безубыток вдвое, и стоп вставал ближе входа, чем настоящий ноль.
