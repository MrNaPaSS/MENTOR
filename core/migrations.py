...
# Первая ревизия - снимок схемы на 17 сентября 2026. Базу, созданную раньше
# миграций, помечаем ею, а не последней: всё, что добавлено позже, к ней ещё
# нужно применить.
BASELINE = "0001"
    ...
    * база уже под миграциями - применяем то, чего ей не хватает.
    ...
    try:
        ...
        if current is None and "students" in tables:
            ...
            say(f"База помечена ревизией {BASELINE}. Данные не тронуты.")
