...
VENUES: tuple[Venue, ...] = (
    ...
    Venue(
        ...
        taker=0.0002,
        maker=0.0,
        # Возврат ученику - те же 10%, что на OKX и BingX (решение владельца
        # от 14 сентября 2026). Партнёрка MEXC платит нам 50% с фьючерсов,
        # так что доля посильная; в боте академии написано то же самое, и
