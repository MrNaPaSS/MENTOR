...
* скидка через академию и доля кешбэка - **не выдуманы**. Пока условия с
  биржей не подписаны, стоит `None`, и витрина пишет «условия уточняются».
  Обещать скидку, которой нет, дороже, чем промолчать: обещание ученик
  запомнит, а оговорку - нет;
