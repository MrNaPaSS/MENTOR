...
BUDGETS: dict[str, tuple[Budget, Budget]] = {
    ...
    # Binance считает не запросы, а их вес: 2400 единиц в минуту на адрес.
    # Торговые ручки весят по единице, позиции - пять. Рыночная половина
    # биржи считает свой вес сама (backend/scalping/binance.py), здесь -
    # только торговля, и запас взят вдвое ниже её порога.
    "binance": (Budget(10, 2.0), Budget(60, 2.0)),
