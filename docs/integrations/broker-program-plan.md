...
Ставка ребейта 50% — **условная**, до договора с WEEX.
...
|---|---|---|---|---|
| **WEEX** | `newClientOrderId` начинается с `b-WEEX123456-`, ≤ 64 символов (спот и фьючерсы) | до 70% (пресса) | Нужно участие в партнёрке — у NMNH есть. API: CheckUserEligibility, GetBrokerCommissionRecords, GetBrokerRebateRatio. Рассмотрение заявки — до 3 рабочих дней | не подана |
