...
Способ доставки решён: **обычный бот**
([A‑02](../audit/AUDIT.md#a-02-userbot-pyrogram--риск-блокировки-личного-аккаунта)). Остаётся открытым
объём MVP веба ([A‑13](../audit/AUDIT.md#a-13-объём-вебаппа-для-mvp)).
