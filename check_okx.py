...
2. **книга и лента** - публичный поток. Собирается ли стакан, цела ли цепочка
   номеров сообщений, идут ли сделки. Контрольной суммой книга больше не
   сверяется: биржа объявила её устаревшей и шлёт в этом поле ноль;
