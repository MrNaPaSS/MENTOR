...
// Единица - размер самого бланка, 1774x887.
//
// Двойка выглядела разумной («на плотном экране единица мыльная»), но бланк
// уходит в мессенджеры, а не на печать: при ней PNG весит восемь с половиной
// мегабайт. Telegram картинку такого веса в превью не разворачивает вовсе -
// под сообщением оставался текстовый прямоугольник без карточки, - а наш же
// приёмник снимков отказывает всему, что тяжелее восьми (`MAX_BYTES`).
//
// Полторы тысячи точек по ширине - это больше, чем показывает любой телефон, и
// ровно столько, сколько нарисовано на самом бланке. Дорисовывать точки, за
// которыми нет рисунка, значит платить мегабайтами за пустоту.
