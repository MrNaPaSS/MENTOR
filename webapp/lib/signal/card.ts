...
// вертикали. Пара и плечо занимают свободное поле слева от значка стороны, а
// время - полосу между полями и девизом.
const COMMON = {
  pair: frame(88, 300, 390, 86),
  leverage: frame(88, 392, 390, 52),
