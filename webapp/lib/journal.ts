...
export type JournalTrade = {
   ...
   *
   * Уже входит в `pnl`, как её считает и сама биржа. Отдельно - чтобы было
   * видно, во сколько обошлось держать позицию: короткие сделки её не платят
   * вовсе, а на долгой она съедает заметную часть результата.
   */
  funding?: number;
