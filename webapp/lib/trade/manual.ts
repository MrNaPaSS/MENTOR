 ...
 *
 * Сторона - по тому, где цена относительно рынка: ниже рынка покупают, выше
 * продают. Это то, что трейдер и имел в виду, ткнув в уровень; спрашивать его
 * об этом отдельно значит спрашивать очевидное.
 *
...
export function draftAt(
  ...
  const side: TradeSide = market > 0 && price > market ? "short" : "long";
