...
export const analytics = {
  ...
  /** Третья панель: что пришло в сигналах и как часто в них заходили. */
  flow: {
    title: "Сигналы и участие",
    hint: "за всё время",
    received: "получено сигналов",
    taken: "взято в работу",
    skipped: "пропущено",
    failed: "не встало",
    activeDays: "дней с сигналами",
    goalDays: "из них в плюс",
    empty: "Сигналов пока не приходило",
  },
