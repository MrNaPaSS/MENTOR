...
export const analytics = {
  ...
  account: {
    ...
    hintJournal: "по журналу терминала",
  ...
  advanced: {
    ...
    /** Дуги качества: винрейт, профит-фактор, просадка. */
    gauges: { title: "Качество", hint: "насколько всё хорошо" },
    ...
    /** Кольцо в первом экране: три разреза на одном месте. */
    rings: {
      sides: { tab: "Стороны", title: "Типы сделок", hint: "лонг против шорта" },
      total: { tab: "Итог", title: "Итог", hint: "из чего сложился" },
      week: { tab: "Дни", title: "Дни недели", hint: "доля сделок по дню" },
    },
