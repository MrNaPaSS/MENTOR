...
export const analytics = {
  ...
  advanced: {
    ...
    /** Раскладки раздела: те же данные, разная подача. */
    views: {
      title: "Вид",
      name: {
        classic: "Классика",
      ...
      hint: {
        classic: "чисто и информативно",
        minimal: "максимум пространства",
        pro: "с акцентом на аналитику",
        table: "для глубокого анализа",
        visual: "инфографика",
      },
    },
    ...
    /** Табличный вид: разрезы и колонки. */
    table: {
