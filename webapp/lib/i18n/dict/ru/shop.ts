...
export const shop = {
  ...
  /** Правая колонка: сообщество, наш софт и подпись бренда. */
  community: {
    lines: ["Больше", "чем торговля -", "это сообщество"],
    join: "Присоединиться",
  },
  soft: {
    title: "Наш софт",
    more: "Подробнее",
    links: {
      features: "Эксклюзивные функции",
      frames: "Оформление профиля",
      merch: "Мерч и аксессуары",
      software: "Полезные инструменты",
    },
  },
