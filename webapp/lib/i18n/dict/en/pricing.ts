export const pricing = {
  ...
  plans: {
    ...
    subtitle: "The first is free and needs an account opened through our link. The second is paid and needs nothing.",
    perMonth: "USDT / month",
    free: {
      name: "Through the academy",
      price: "0",
      priceNote: "while you trade through us",
      hint: "Account opened through the academy link",
      features: [
        "The whole workplace, nothing stripped out",
        "Part of your fee comes back to the account",
        "Academy, live chat and trade reviews",
        "Coins, achievements and the certificate",
      ],
  ...
  compare: {
    ...
    rows: [
      ...
      { label: "Cluster, volume candles and VISION", free: "for coins", base: false, pro: true },
      { label: "100-row book and step ×25", free: "for coins", base: false, pro: true },
      { label: "Entry, target and stop screenshots in the journal", free: false, base: false, pro: true },
      { label: "Journal and analytics history", free: "full", base: "3 months", pro: "full" },
      { label: "Journal export", free: "for coins", base: false, pro: true },
