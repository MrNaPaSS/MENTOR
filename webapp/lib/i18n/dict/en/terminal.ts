...
export const journal = {
  ...
  coinsLabel: "Coins",
  spans: { day: "Day", week: "Week", month: "Month" },
  spanNow: { day: "Today", week: "This week", month: "This month" },
  spanPrev: "Previous",
  spanNext: "Next",
  ...
  workShots: "Shots",
  workTold: "With notes",
  workHeld: "Average time",
  undoneTitle: "Left to review",
  undoneNoShot: "No shots",
  undoneNoMark: "Not marked",
  undoneOpen: "Open the first",
  totalsDay: "Day total",
  totalsMonth: "Month total",
  totalsYear: "Year total",
  daysIn: (n: number) => `${n} d.`,
  coinsIn: (n: number) => `${n} coins`,
  weekTotalsTitle: "Week total",
  weekTradesLabel: "Reviewed",
  weekGainLabel: "On margin",
  weekWinrateLabel: "Winners",
  weekBreaksLabel: "Rule breaks",
  tradesIn: (n: number) => `${n} trades`,
  backToCoins: "Coins",
  positionsIn: (n: number) => `${n} pos.`,
  ...
  planTitle: "Plan for the week",
  planHint: "What I trade, by which rules, what I avoid. Saves itself.",
  ...
  shotSaving: "Saving...",
  shotNoteHint: "caption: what is visible here",
