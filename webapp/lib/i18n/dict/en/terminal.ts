export const terminal = {
  ...
  toolLocked: (name: string) => `${name} is a market tool. Click to open it in Tools`,
  toolNames: {
    vision: "NMNH VISION",
  ...
  autoShot: "Shoot on trade events",
...
export const journal = {
  exportCsv: "Export a report on the last year of the journal: charts, stats and every trade",
  exportLocked: "Journal export is a Store tool, see Tools",
  exportFailed: "Could not export the journal",
  exportLeft: (left: number, limit: number) => `${left} of ${limit}`,
  exportLeftTitle: (left: number, limit: number, reset: string) =>
    `Exports left this month: ${left} of ${limit}. New ones on ${reset}`,
  exportSpent: (reset: string) => `No exports left this month. New ones on ${reset}`,
  report: {
    title: "Trading journal report",
    subtitle: "NMNH TRADE · terminal",
    period: (from: string, to: string) => `Period: ${from} - ${to}`,
    made: (at: string) => `Exported ${at}`,
    quota: (used: number, limit: number) => `export ${used} of ${limit} this month`,
    ...
    kpi: {
      ...
      worst: "Worst trade",
      streaks: "Streaks",
      streaksValue: (wins: number, losses: number) => `${wins} wins · ${losses} losses`,
    },
    wins: (wins: number, losses: number) => `${wins} wins, ${losses} losses`,
    equity: "Equity curve",
    equityHint: "Running result after every closed trade",
    days: "Result by day",
    daysHint: "Last 60 trading days",
    outcomes: "How trades closed",
    outcome: { take: "target", stop: "stop", manual: "manual" },
    sides: "Long and short",
    side: { long: "long", short: "short" },
    symbols: "By coin",
    hours: "By hour",
    hoursHint: "Result by closing hour, local time",
    table: {
      title: "All trades",
      closed: "Closed",
      coin: "Coin",
    ...
    csv: "Download CSV",
    print: "Save as PDF",
    empty: "No closed trades in this period.",
    footer: "Report built by the NMNH TRADE terminal from the trading journal. Not investment advice.",
  },
  title: "Trade journal",
  ...
  colExit: "Exit",
  colTargets: "Targets",
  shotOpen: "Open the shot",
  shotBack: "Back to the list",
  shotPrev: "Previous shot",
  shotNext: "Next shot",
  ...
  long: "long",
  short: "short",
  shotsIn: (n: number) => `${n} shots`,
  positionNo: (n: number) => `Position #${String(n).padStart(3, "0")}`,
  cardStop: "Stop",
  cardTargets: "Targets",
  cardRR: "Risk to target",
  cardQty: "Size",
  ...
  stageEmpty: "no shots",
  planMark: "Discipline",
  planKept: "by the plan",
  planBroken: "broken",
  mistakes: {
    late: "entered mid-move",
    risk: "raised the risk",
    session: "outside the session",
    average: "averaged down",
    fomo: "FOMO",
  ...
  planForms: {
    ...
    work: "Working on myself",
    free: "In my own words",
  },
  planFields: {
    goals: "Goals",
    trade: "What I trade",
    rules: "By which rules",
    avoid: "What I avoid",
    risk: "Risk per trade",
    dayStop: "Daily stop",
    count: "Trades per day",
    hours: "When I trade",
    fails: "What went wrong last week",
    repeat: "What I repeat",
    habit: "One habit for this week",
    free: "Plan in my own words",
  },
  planHints: {
    goals: "what I want from the week - in trades, not in money",
    trade: "coins and timeframe I work with",
    rules: "entry, stop, move to breakeven",
    avoid: "what I blame myself for every week",
    risk: "how much I lose on one trade",
    dayStop: "the loss after which I close the terminal",
    count: "the limit past which an entry is just boredom",
    hours: "hours and sessions outside of which I do not enter",
    fails: "from last week journal, not from memory",
    repeat: "what worked and is worth repeating",
    habit: "one. not a list",
    free: "however suits you",
  },
  planPrev: "Previous template",
  planNext: "Next template",
  weekTrades: (marked: number, all: number) => `${marked} / ${all} trades reviewed`,
  weekTradesHint: "A trade counts as reviewed once it is marked kept or broken",
  weekGain: (value: string) => `${value} on margin`,
  weekGainHint: "Week result against margin used. No percent of account here: the account lives in analytics",
  weekWinrate: (value: string) => `Winrate ${value}`,
  weekWinrateHint: "Share of winning trades this week",
  weekBreaks: (n: number) => `${n} rule ${n === 1 ? "break" : "breaks"}`,
  weekBreaksHint: "Counted only from your own marks in the position card",
  weekEmpty: "No closed trades this week",
  foldersMore: (n: number) => `${n} more`,
  foldersLess: "Collapse",
  weekReviewMake: "Build week review",
  weekReviewTitle: (week: string) => `Week review ${week}`,
  weekReviewEmpty: "Nothing to review: no closed trades this week",
  weekReviewTotals: "Totals",
  weekReviewBest: "Best position",
  weekReviewWorst: "Worst position",
  ...
  weekReviewAfterLossLine: (n: number, minutes: number) =>
    `${n} trades opened within ${minutes} minutes of a losing one`,
  weekReviewAfterLossNone: (minutes: number) =>
    `No entries within ${minutes} minutes of a loss`,
  weekReviewCopy: "Copy as text",
  weekReviewCopied: "Review copied",
  weekReviewTrades: (n: number) => `${n} trades`,
  galleryEmpty: "No shots for this period. Attach them to trades - they gather here.",
  tabList: "List",
  tabReview: "Review",
  ...
  shotAdd: "Pick a file",
  shotPaste: "Ctrl+V pastes a picture from the clipboard",
  shotSaving: "Saving...",
  shotRemove: "Remove shot",
  shotFailed: "The shot was not saved",
  shotsOpen: "Trade review shots",
  colResult: "Result",
...
export const pnlCard = {
  ...
  stopPrice: "Stop",
  stopBreakeven: "break-even",
  targetsRow: "Targets",
  ofTargets: (hit: number, total: number) => `${hit} of ${total}`,
  lockedRow: "Locked in",
  floatingRow: "Open part",
