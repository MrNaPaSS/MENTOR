...
// «Последняя цель» и «безубыток» - это выход, хотя в первой стоит слово
// «цель»: выход у сделки один, и он бывает целью так же, как стопом.
// Список выхода проверяется раньше списка сопровождения - потому и
// «последн» здесь, а не там.
const EXIT_WORDS = [
  "закрыт",
  "выход",
  "стоп",
