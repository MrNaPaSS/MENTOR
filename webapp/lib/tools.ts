...
//
// Бесплатно у всех: стакан в 30 строк, шаги ×1, ×5 и ×10, полки ликвидности,
// объём под графиком и EMA. Остальное открывает покупка - или отметка VIP, которую
...
export const TOOL = {
  /** Разметка графика: тренд, структура, блоки, FVG, зоны. Полки, объём и EMA - у всех. */
  vision: "tool_vision",
...
/** Слои разметки, которые открывает NMNH VISION. Полки, объём и EMA - у всех. */
export const VISION_LAYERS = ["trend", "structure", "blocks", "gaps", "zones"] as const;
