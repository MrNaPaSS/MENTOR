  ...
  return (
    <section id="how" className="mx-auto max-w-6xl px-4 py-20 md:px-6 md:py-28">
      ...
      <Reveal className="mt-14">
        <div className="overflow-x-auto rounded-2xl border border-border bg-bg-panel/85 backdrop-blur-xl p-4 md:p-6">
          <svg
            viewBox="0 0 860 300"
        ...
        {t.broker.flow.steps.map((step, i) => {
          ...
          return (
            <Reveal as="article" key={step.title} delay={i * 0.1}>
              <div className="h-full rounded-2xl border border-border bg-bg-panel/85 backdrop-blur-xl p-5">
