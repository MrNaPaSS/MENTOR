        ...
        {t.broker.included.items.map((item, i) => {
          ...
          return (
            <Reveal as="article" key={item.title} delay={i * 0.07}>
              <div className="group h-full rounded-2xl border border-border bg-bg-card/95 backdrop-blur-sm p-5 transition-all duration-300 hover:-translate-y-1 hover:border-accent-cyan/30">
