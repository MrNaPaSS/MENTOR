  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4">
      ...
      <div style={{ perspective: "2200px" }} className="relative z-10 h-[78vh] max-h-[760px] w-full max-w-[1400px]">
        <div
          className="flex h-full flex-col overflow-hidden rounded-xl border border-[var(--pane-border)] bg-[#0b0e11] shadow-[0_24px_80px_rgba(0,0,0,0.7)] transition-all duration-500 ease-[cubic-bezier(.22,.68,.16,1)]"
          style={{
        ...
        >
          {/* Шапка */}
          <div className="flex shrink-0 items-center justify-between border-b border-[var(--pane-border)] px-3 py-2.5 sm:px-4">
            <div className="flex items-center gap-2.5">
              <span className="font-mono text-base font-extrabold text-[var(--pane-text)] sm:text-lg">{symbol}</span>
              {long !== null && (
                <span
          ...
          <div className="grid min-h-0 flex-1 grid-rows-[1fr_40vh] lg:grid-cols-[1fr_340px] lg:grid-rows-1">
            ...
            <div ref={bookRef} className="min-h-0 overflow-hidden border-t border-[var(--pane-border)] lg:border-l lg:border-t-0">
