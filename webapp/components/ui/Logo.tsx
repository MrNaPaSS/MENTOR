...
export default function Logo({ href = "/", adminBadge, className = "", tone = "text-text-primary" }: LogoProps) {
  return (
    ...
    >
      {/* Астронавта в шапке нет намеренно: он живёт иконкой вкладки, где
          картинка - единственное, чем страница может назваться. Здесь рядом с
          ним стоит написанный знак, и два знака подряд спорят друг с другом за
          то, чем сайт представляется. */}
