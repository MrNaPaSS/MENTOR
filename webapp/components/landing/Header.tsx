...
export default function Header({ links }: HeaderProps = {}) {
  ...
  return (
    <>
      ...
      {/* Мобильное меню - соседом шапки, а не внутри неё.
          При прокрутке шапка включает размытие фона, а элемент с
          размытием становится системой отсчёта для всего, что внутри
          него закреплено на экране. Меню переставало занимать экран и
          сжималось до полосы шапки: пункты ложились поверх страницы, а
          подложка с фоном оставались в шапке - со стороны это выглядело
          прозрачной панелью. */}
      <div
