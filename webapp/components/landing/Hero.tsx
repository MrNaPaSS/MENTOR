      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-4 md:px-6">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-h1 text-text-primary">
            <span className="glitch" data-text={t.landing.hero.titleTop}>
              {t.landing.hero.titleTop}
            </span>
            <br />
            <span className="text-accent-cyan text-glow-cyan">{t.landing.hero.titleAccent}</span>
          </h1>
          ...
          <ul className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-text-muted">
            {t.landing.hero.bullets.map((item) => (
