...
> = {
  ...
  light: {
    // Прозрачно намеренно: под холстом лежит бумага в клетку - тот же фон, что
    // на странице входа. Сплошной белый её закрывал бы.
...
function PriceChart({
  ...
  return (
    ...
    <div
      ...
      //
      // Та же сетка, что на странице входа: шаг сорок восемь пикселей, линии
      // едва различимы. Она не заменяет сетку самого графика - та привязана к
      // ценам и времени и нужна для отсчёта, - а даёт лист, на котором график
      // нарисован. На тёмной теме листа нет: там холст сам по себе чёрный.
      style={
        theme === "light"
          ? {
              backgroundColor: "#FAFAFC",
              backgroundImage:
                "linear-gradient(to right, rgba(42,42,62,0.05) 1px, transparent 1px)," +
                "linear-gradient(to bottom, rgba(42,42,62,0.05) 1px, transparent 1px)",
