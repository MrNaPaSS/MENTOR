    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      {score && (
        <button
          ...
          className="pointer-events-auto absolute bottom-6 right-16 z-10 overflow-hidden rounded border text-left font-mono text-[10px] tabular-nums shadow transition-opacity duration-150 ease-out hover:opacity-80"
