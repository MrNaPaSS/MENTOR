...
export const metadata: Metadata = {
  ...
  description:
    "Экосистема трейдера: торговый терминал со стаканом и графиком, софт под твой счёт на бирже, живой чат, журнал сделок с активностями и внутренний токен NMNH.",
  ...
  openGraph: {
    ...
    description:
      "Терминал, софт под твою биржу, живой чат, журнал сделок с активностями и внутренний токен - в одной экосистеме.",
    type: "website",
    locale: "ru_RU",
