...
//
// Нижняя граница стакана - не по его колонкам, а по его шапке. Колонки
// помещаются и в триста двадцать точек (111 истории плюс 177 цены с полями),
// но в шапке рядом стоят монета, четыре множителя шага, сам шаг в деньгах и
// три глубины: уже трёхсот восьмидесяти этот ряд переносится, и стакан
// открывается с шагом и глубиной, уехавшими на вторую строку.
const PANE_LIMITS = {
  screener: { def: 500, min: 360, max: 900 },
  dom: { def: 620, min: 380, max: 1200 },
