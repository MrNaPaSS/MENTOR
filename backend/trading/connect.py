...
* счёт, которого академия не знает, подключается как свой (`own`) - с
  ограничениями, но подключается: запрещать человеку его собственный счёт мы
  не вправе (ТЗ мультибиржи, §4.1).
...
from backend.trading.accounts import access_kind, account_for, confirmed_uids
