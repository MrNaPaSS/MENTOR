...
# Ширина одной колонки истории и сколько их держим: минута на восьми колонках.
#
...
# Колонок именно восемь, а не больше: каждая занимает фиксированную ширину на
# экране, и пятнадцать пустых колонок оставляли стакану полоску у края.
