...
TOOLS: dict[str, str] = {
    # Разметка графика: тренд, структура, блоки, FVG и зоны. Полки
    # ликвидности, объём и EMA остаются у всех - это язык терминала.
    ...
    # Терминал сам снимает график на входе, на каждой взятой цели и на
    # закрытии и кладёт снимки в журнал по этапам сделки.
    "tool_auto_shots": "Автоснимки сделок",
}
